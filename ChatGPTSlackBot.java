...
public class ChatGPTSlackBot {

    private static final String SLACK_BOT_TOKEN = "xoxb-5687039969424-5655905048503-w46vAU716PPLZezKncshLYN8";

    public static void main(String[] args) {
        Slack slack = Slack.getInstance();
        MethodsClient methods = slack.methods(SLACK_BOT_TOKEN);

        String channelId = "C05KEC4HZ37";

        LocalDateTime startTimeUTC = LocalDateTime.of(2023, Month.AUGUST, 3, 10, 0);
        LocalDateTime endTimeUTC = LocalDateTime.of(2023, Month.AUGUST, 8, 15, 0);
